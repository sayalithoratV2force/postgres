...
public class HomeControllerTest {
    ...
    public class Home {
        ...
        public void shouldAddInsertRecordToModelMap() throws Exception {
            ...
            assertThat(map, hasKey("newTask"));
            assertTrue(map.get("insertRecord") instanceof Record);

            Record insertRecord = (Record) map.get("newTask");
            assertNull(insertRecord.getName());
        }
    ...
    public class InsertData {
        ...
        @Before
        public void setUp() throws Exception {
            bindingResult = new MapBindingResult(new HashMap<>(), "newTask");
        }
